...
class TriangleError(RuntimeError):
    def __init__(self, side1, side2, side3):
        super().__init__("Invalid triangle sides: {}, {}, {}".format(side1, side2, side3))
        self.__side1 = side1
        self.__side2 = side2
        self.__side3 = side3
...
class Triangle(GeometricObject):
    ...
    def isValid(self):
        return self.__side1 + self.__side2 > self.__side3 and self.__side1 + self.__side3 > self.__side2 and self.__side2 + self.__side3 > self.__side1
